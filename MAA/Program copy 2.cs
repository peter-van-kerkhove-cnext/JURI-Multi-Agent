    ...
    public static async Task Main2()
    {
        ...
        ChatCompletionAgent agentCoach =
            new()
            {
                ...
                Instructions =
                    """
                    You are a coach for Juri - a construction company.
                    Users can have a questions on stock related topics on Juri's construction machines, Juri specific know-how on construction, Rules and regulations in the building industry. 
                                   
                    Your sole responsiblity is to help answering the question of the user.
                    You do this by classifying the user question and respond with :
                    1- STOCK:
                    ...
                    * in case of a user question is asking information in the context of building and construction
                    ...
                    RULES:
                    - only respond with STOCK, EXPERT or otherwise request the user to make the question more specific.
                    """,
                    // Great the user.
        ...
        ChatCompletionAgent agentStock =
            new()
            {
                ...
                Instructions =
                    """
                    Your sole responsiblity is to retreive the requested information for Juri's construction machinery.
        ...
        KernelFunction selectionFunction =
            AgentGroupChat.CreatePromptFunctionForStrategy(
                ...
                - If RESPONSE is user input, it is {{{CoachName}}}'s turn.
                - If RESPONSE is by {{{CoachName}}} and contains "STOCK", it is {{{StockManagerName}}}'s turn.
                - If RESPONSE is by {{{CoachName}}} and contains "EXPERT", it is {{{KnowledgeExpertName}}}'s turn.
                
                - If RESPONSE is by {{{StockManagerName}}} , it is {{{StockManagerName}}}'s turn.
                
                - else it is {{{CoachName}}}'s turn
